    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                editTeman(new Barang(ed_Nama.getText().toString(), ed_Telpon.getText().toString()));
            }
        });
    }

    public void editTeman(Barang barang){
        databaseReference.child("Barang").child(kode).setValue(barang).addOnSuccessListener(this, new OnSuccessListener<Void>() {
            @Override
